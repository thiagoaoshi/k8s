#!/bin/bash
# Upgrade do WORKER seus recursos, executar como root.
...
echo -e "COLOQUE O NODE EM MANUTENCAO !...\n"
echo -e "> Acesse um node Control Plane e execute o comando abaixo: \e[1m${NODE_NAME}\e[0m \n"
echo -e ">  kubectl drain ${NODE_NAME} --ignore-daemonsets --delete-emptydir-data --force \n"
echo
read -n1 -r -p "Se o node entrou manutenção aperte qualquer tecla para continuar..." key
...
echo -e "> Acesse o control plane e execute o comando abaixo:...\n"
echo -e "> kubectl uncordon ${NODE_NAME} \n"
